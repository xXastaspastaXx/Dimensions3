...
public class CustomInsideCommand extends DimensionsCommand {

	DimensionsCustomLighter main;

	public CustomInsideCommand(String command, String args, String[] aliases, String description, String permission, boolean adminCommand, DimensionsCustomLighter main) {
	...
	public void execute(CommandSender sender, String[] args) {
		...
		main.getPortalConfig(portal).set("Addon.CustomLighter.InsideBlock", data);
		
		p.sendMessage("§7[§cDimensions§7] §aThe custom inside block type was succesfully updated, please reload Dimensions");
