...
public class AdminHelpCommand extends DimensionsCommand {
	...
	public AdminHelpCommand(String command, String args, String[] aliases, String description, String permission, boolean adminCommand) {
	...
	public void execute(CommandSender sender, String[] args) {
		...
		ArrayList<DimensionsCommand> commandList = DimensionsCommandManager.getAdminCommands();
